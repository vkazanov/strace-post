...
Конечно, в рамках данной статьи разбирать исходный код самого strace не разумно, но я все же
...
Piglet Trace понимает порядка сотни системных вызовов (см. приложенную таблицу) Linux и работает
только на архитектуре x86-64, но нас эти ограничения вполне устраивают.
