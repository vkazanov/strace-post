...
Помимо, собственно, инъекции ошибок можно имитировать задержки при выполнение вызовов, получение
сигналов и [[http://www.man7.org/linux/man-pages/man1/strace.1.html][множество других необходимых при отладке вещей]].
